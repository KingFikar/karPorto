...
const translations = {
  id: {
    ...
    "proj.hospital.tag":"Healthcare &middot; Mobile","proj.hospital.title":"Sistem Layanan RS Mutiara Sukma",
    "proj.hospital.desc":"Aplikasi mobile dan sistem internal untuk operasional rumah sakit &middot; terintegrasi penuh dengan Google Play Console untuk distribusi ke pengguna medis.",
    "proj.pos.tag":"Mobile &middot; POS","proj.pos.title":"Aplikasi POS Kasir Coffeeshop",
    "proj.pos.desc":"Aplikasi kasir lintas platform untuk coffeeshop &middot; manajemen pesanan, cetak struk (invoice), dan integrasi database real-time.",
    ...
    "proj.diklat.tag":"Web &middot; Pendidikan","proj.diklat.desc":"Sistem Informasi Pendidikan &amp; Pelatihan &middot; platform diklat dengan profil, modul, dan pelacakan sertifikasi.",
    "proj.billing.tag":"Web &middot; Otomasi","proj.billing.title":"Billing System Otomatis",
    "proj.billing.desc":"Sistem tagihan &amp; pembayaran otomatis &middot; menunjukkan kemampuan logika backend yang kompleks dan integrasi payment gateway.",
  ...
  en: {
    ...
    "proj.pos.tag":"Mobile &middot; POS","proj.pos.title":"Coffeeshop POS Cashier App",
    "proj.pos.desc":"Cross-platform cashier app for coffeeshop &middot; order management, receipt printing, and real-time database integration.",
    ...
    "proj.diklat.tag":"Web &middot; Education","proj.diklat.desc":"Education &amp; Training Information System &middot; a training platform with profiles, modules, and certification tracking.",
    "proj.billing.tag":"Web &middot; Automation","proj.billing.title":"Automated Billing System",
    "proj.billing.desc":"Automated billing &amp; payment system &middot; demonstrating complex backend logic and payment gateway integration.",
